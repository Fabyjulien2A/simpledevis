<x-guest-layout>
    ...
    <a href="{{ route('legal.cgv') }}" class="font-medium text-indigo-600 underline">CGV</a>
    et la
    <a href="{{ route('legal.confidentialite') }}" class="font-medium text-indigo-600 underline">politique de confidentialité</a>.
</p>
